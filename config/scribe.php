...
return [
    ...
    'description' =>  'API REST headless pour transformer du contenu technique brut en posts optimisés pour X (Twitter).',
    ...
    'auth' => [
        ...
        'use_value' => env('SCRIBE_AUTH_KEY', '2|IgtoZuuObkgFJhBmBp2tRNMQ44kN30bebB4IFOtT247f64fe'),
        ...
        'extra_info' => 'Récupère ton token via POST /api/auth/login',
    ],
